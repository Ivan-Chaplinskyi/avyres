...
class SwiperComponent extends HTMLElement {
  ...
  init() {
    ...
    const option = {
      ...
      slidesPerViewDesktop: swiperOptions.slidesPerViewDesktop ||
        swiperOptions.slidesPerView ||
        4,
      slidesPerViewTablet: swiperOptions.slidesPerViewTablet ||
        swiperOptions.slidesPerViewDesktop ||
        swiperOptions.slidesPerView ||
        3,
      spaceBetween: swiperOptions.spaceBetweenMobile || 0,
      spaceBetweenDesktop: swiperOptions.spaceBetweenDesktop ||
        swiperOptions.spaceBetween ||
        0,
      spaceBetweenTablet: swiperOptions.spaceBetweenTablet ||
        swiperOptions.spaceBetweenDesktop ||
        swiperOptions.spaceBetweenMobile ||
        0,
      enabled: swiperOptions.enabled ?? true,
      enabledDesktop: swiperOptions.enabledDesktop ?? swiperOptions.enabled ?? true,
      enabledTablet: swiperOptions.enabledTablet ??
      ...
      allowTouchMove: swiperOptions.allowTouchMove ??
        (typeof swiperOptions.slidesPerView === "number" ?
          ...
          false :
          true),
      allowTouchMoveTablet: swiperOptions.allowTouchMoveTablet ??
        (typeof swiperOptions.slidesPerViewTablet === "number" ?
          swiperOptions.slideCount > swiperOptions.slidesPerViewTablet ?
          true :
          false :
          true),
      allowTouchMoveDesktop: swiperOptions.allowTouchMoveDesktop ??
...
class ShowPopup extends HTMLElement {
  ...
  connectedCallback() {
    this.querySelectorAll('[data-toggle-popup]').forEach(btn => {
